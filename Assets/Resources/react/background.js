...
(function() {
  ...
  const GameBackground = () => {
    ...
    const isGameOverRef = reactExports.useRef(status.isGameOver);
    const isPausedRef = reactExports.useRef(status.isPaused);
    reactExports.useEffect(() => {
    ...
    return (
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "w-full h-full overflow-hidden items-center justify-center", style: { backgroundColor: "#0f172a" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "absolute inset-0", style: { opacity: 0.05 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "view",
        {
          style: {
            position: "absolute",
  ...
  render(/* @__PURE__ */ jsxRuntimeExports.jsx(GameBackground, {}));
})();
