...
(function() {
  ...
  const Menu = ({ onNavigate, onPlay }) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-col items-center w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-3xl mb-5 text-white font-['Melete-Bold']", children: "Main Menu" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "mb-2.5 w-60", onClick: onPlay, children: "Play Game" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "mb-2.5 w-60", onClick: () => onNavigate("ranking"), children: "Ranking" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "mb-2.5 w-60", onClick: () => onNavigate("settings"), children: "Settings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "w-60", onClick: () => onNavigate("title"), children: "Back to Title" })
    ] });
  };
  ...
  const TitleApp = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "w-full h-full flex-col justify-center items-center bg-black", children: [
      currentScreen === "title" && /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "w-full h-full flex-col items-center justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-6xl mb-10 text-white", style: { fontFamily: "Melete-Bold" }, children: "GeomeTRIo" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-xl animate-pulse text-gray-400", style: { fontFamily: "Melete-Medium" }, children: "Press Any Button" })
      ] }),
      currentScreen === "menu" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Menu,
        {
      ...
      currentScreen === "ranking" && /* @__PURE__ */ jsxRuntimeExports.jsx(Ranking, { onBack: () => setCurrentScreen("menu") }),
      currentScreen === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { onBack: () => setCurrentScreen("menu") })
    ] });
  };
