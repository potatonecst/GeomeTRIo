...
(function() {
  ...
  __vite_style__.textContent = "/* Standard CSS *//*$vite$:1*/";
  ...
  const TitleApp = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { style: { flex: 1, justifyContent: "center", alignItems: "center", backgroundColor: "white" }, children: [
      currentScreen === "title" && /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => setCurrentScreen("menu"), style: { width: 200, height: 50 }, children: "Start" })
      ] }),
      currentScreen === "menu" && /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { style: { fontSize: 30, marginBottom: 20 }, children: "Main Menu" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { style: { marginBottom: 10 }, onClick: () => console.log("Game Start!"), children: "Play Game" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { style: { marginBottom: 10 }, onClick: () => setCurrentScreen("ranking"), children: "Ranking" }),
