...
(function() {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "view",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-col items-end transition-opacity duration-500 ${hudState.labels ? "opacity-100" : "opacity-0"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-600 text-3xl tracking-widest mb-1", children: "STAGE" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-600 text-3xl tracking-widest mb-1", children: "TIME" }),
        ...
        "view",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-col transition-opacity duration-500 ${hudState.labels ? "opacity-100" : "opacity-0"}`, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `mb-6 ${status.hp <= 1 ? "animate-pulse" : ""}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row justify-between mb-1", children: [
                  ...
                  hudState.vital ? /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { className: `${status.hp <= 1 ? "text-red-500" : "text-white"} text-2xl`, children: [
                    status.hp,
                    " / ",
                    status.maxHp
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "mb-8", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row justify-between mb-1", children: [
                  ...
                  hudState.weapon ? /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { className: "text-white text-2xl", children: [
                    "x ",
                    status.sp
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "flex-row justify-between mb-1", children: hudState.weapon ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { className: "text-yellow-400 text-2xl tracking-widest", children: [
                    "LV ",
                    status.level
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { className: "text-white text-xl", children: [
                    "EXP ",
                    status.currentExp,
                    " / ",
                    status.nextExp
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-2xl tracking-widest", children: "LV --" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-xl", children: "EXP -- / --" })
                ] }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-1 border-t-2 border-cyan-900 pt-4 mt-auto transition-opacity duration-500 ${hudState.labels ? "opacity-100" : "opacity-0"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-600 text-2xl tracking-widest mb-2", children: "STATUS MONITOR" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-col gap-1 opacity-70", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-row ${status.hp <= 1 ? "animate-pulse" : ""}`, children: [
                  ...
                  hudState.system ? /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ml-2 ${status.hp <= 1 ? "text-red-500" : "text-green-500"}`, style: { fontFamily: "SourceHanCodeJP" }, children: status.systemStatus }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-2xl ml-2", style: { fontFamily: "SourceHanCodeJP" }, children: "---" })
                ] }),
  ...
  const ScorePopup = () => {
    ...
    return (
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "absolute top-36 right-8 flex-col items-end pointer-events-none", children: popups.map((popup) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "view",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { className: "text-yellow-400 text-4xl font-bold", style: { textShadow: "0 0 5px yellow", fontFamily: "SourceHanCodeJP" }, children: [
              "+",
              popup.amount
            ] })
          ]
  ...
  const GameOverPanel = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "view",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-col items-center p-12 border-4 border-red-600 bg-black w-[800px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GlitchText, { text: "GAME OVER", isAlert: true, className: "text-8xl text-red-600 mb-4 font-bold tracking-widest" }),
          status.isNewHighScore && /* @__PURE__ */ jsxRuntimeExports.jsx(GlitchText, { text: "NEW HIGH SCORE!", isAlert: false, className: "text-5xl text-yellow-400 mb-12 font-bold tracking-widest animate-pulse" }),
  ...
  const PausePanel = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        className: "absolute inset-0 items-center justify-center bg-black bg-opacity-80 transition-opacity duration-500 pointer-events-auto",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-col items-center p-12 border-4 border-cyan-600 bg-black w-[800px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GlitchText, { text: "PAUSE", isAlert: false, className: "text-8xl text-cyan-600 mb-12 font-bold tracking-widest" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row w-full justify-between px-12 mt-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "w-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              MenuButton,
              {
