...
(function() {
  ...
  const SystemAlert = ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "absolute inset-0 flex items-center justify-center bg-black bg-opacity-95", style: { zIndex: 999 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "relative w-[900px] bg-black p-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "mb-8 text-center text-xl text-white leading-relaxed whitespace-pre-wrap", style: { fontFamily: "SourceHanCodeJP" }, children: message }),
