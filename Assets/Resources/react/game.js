...
(function() {
      ...
      const loop = () => {
        if (interop && typeof interop.GetInGameStatus === "function") {
          try {
            ...
            setStatus((prev) => __spreadValues(__spreadValues({}, prev), data));
          } catch (e) {
          }
        }
  ...
  const ProgressBar = ({ value, max, color }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "w-full h-6 bg-gray-900 border border-gray-700 relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "absolute inset-0 flex-row justify-between px-1 pointer-events-none", children: Array.from({ length: 9 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "w-[1px] h-full bg-black opacity-50" }, i)) }),
  ...
  const HUD = ({ hudState }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "w-full h-full pointer-events-none relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "view",
        {
          className: `${sidebarStyle} border-r-2 items-end left-0 ${hudState.frame ? "opacity-100" : "opacity-0"}`,
          style: { width: 550 },
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-col items-end transition-opacity duration-500 ${hudState.labels ? "opacity-100" : "opacity-0"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-600 text-3xl tracking-widest mb-1", style: { fontFamily: "SourceHanCodeJP" }, children: "STAGE" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "mb-8 h-10 flex items-center justify-end", children: hudState.isScanning ? /* @__PURE__ */ jsxRuntimeExports.jsx(GlitchText, { text: "SCANNING...", className: "text-yellow-400 text-4xl tracking-widest", style: { fontFamily: "SourceHanCodeJP" } }) : hudState.env ? /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-white text-4xl tracking-widest", style: { fontFamily: "SourceHanCodeJP" }, children: status.stageName }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-4xl tracking-widest", style: { fontFamily: "SourceHanCodeJP" }, children: "---" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-600 text-3xl tracking-widest mb-1", style: { fontFamily: "SourceHanCodeJP" }, children: "TIME" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "h-10 flex items-center justify-end mb-auto", children: hudState.telemetry ? /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-white text-4xl tracking-widest", style: { fontFamily: "SourceHanCodeJP" }, children: formatTime(status.timeElapsed) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-4xl tracking-widest", style: { fontFamily: "SourceHanCodeJP" }, children: "00:00" }) })
          ] })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "view",
        {
          ...
          style: { width: 550 },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-col transition-opacity duration-500 ${hudState.labels ? "opacity-100" : "opacity-0"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "mb-8", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-600 text-3xl tracking-widest mb-1 whitespace-nowrap", style: { fontFamily: "SourceHanCodeJP" }, children: "SCORE" }),
                hudState.telemetry ? /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-white text-7xl tracking-wider whitespace-nowrap", style: { fontFamily: "SourceHanCodeJP" }, children: Math.min(status.score, 9999999999).toString().padStart(10, "0") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-7xl tracking-wider whitespace-nowrap", style: { fontFamily: "SourceHanCodeJP" }, children: "0000000000" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `mb-6 ${status.hp <= 1 ? "animate-pulse" : ""}`, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row justify-between mb-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `${status.hp <= 1 ? "text-red-500" : "text-cyan-600"} text-2xl tracking-widest`, style: { fontFamily: "SourceHanCodeJP" }, children: "HP" }),
                  hudState.vital ? /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { className: `${status.hp <= 1 ? "text-red-500" : "text-white"} text-2xl`, style: { fontFamily: "SourceHanCodeJP" }, children: [
                    status.hp,
                    " / ",
                    status.maxHp
                  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-2xl", children: "-- / --" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar, { value: hudState.vital ? status.hp : 0, max: status.maxHp, color: status.hp <= 1 ? "#ff3333" : "#00ff00" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "mb-8", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row justify-between mb-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-600 text-2xl tracking-widest", style: { fontFamily: "SourceHanCodeJP" }, children: "SP CHARGE" }),
                  hudState.weapon ? /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { className: "text-white text-2xl", style: { fontFamily: "SourceHanCodeJP" }, children: [
                    "x ",
                    status.sp
                  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-2xl", children: "x -" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar, { value: hudState.weapon ? status.spCharge : 0, max: status.maxSpCharge, color: "#00ffff" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "mb-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "flex-row justify-between mb-1", children: hudState.weapon ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { className: "text-yellow-400 text-2xl tracking-widest", style: { fontFamily: "SourceHanCodeJP" }, children: [
                    "LV ",
                    status.level
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { className: "text-white text-xl", style: { fontFamily: "SourceHanCodeJP" }, children: [
                    "EXP ",
                    status.currentExp,
                    " / ",
                    status.nextExp
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-2xl tracking-widest", style: { fontFamily: "SourceHanCodeJP" }, children: "LV --" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-xl", style: { fontFamily: "SourceHanCodeJP" }, children: "EXP -- / --" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar, { value: hudState.weapon ? status.currentExp : 0, max: status.nextExp, color: "#facc15" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-1 border-t-2 border-cyan-900 pt-4 mt-auto transition-opacity duration-500 ${hudState.labels ? "opacity-100" : "opacity-0"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-600 text-2xl tracking-widest mb-2", style: { fontFamily: "SourceHanCodeJP" }, children: "STATUS MONITOR" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-col gap-1 opacity-70", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-row ${status.hp <= 1 ? "animate-pulse" : ""}`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ${status.hp <= 1 ? "text-red-500" : "text-cyan-600"}`, style: { fontFamily: "SourceHanCodeJP" }, children: "> SYSTEM: " }),
                  hudState.system ? /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ml-2 tracking-widest ${status.hp <= 1 ? "text-red-500" : "text-green-500"}`, style: { fontFamily: "SourceHanCodeJP" }, children: status.systemStatus }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-2xl ml-2", style: { fontFamily: "SourceHanCodeJP" }, children: "---" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-row ${status.engineStatus === "DESTROYED" ? "animate-pulse" : ""}`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ${status.engineStatus === "DESTROYED" ? "text-red-500" : "text-cyan-600"}`, style: { fontFamily: "SourceHanCodeJP" }, children: "> ENGINE: " }),
                  hudState.engine ? /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ml-2 tracking-widest ${status.engineStatus === "DESTROYED" ? "text-red-500" : "text-white"}`, style: { fontFamily: "SourceHanCodeJP" }, children: status.engineStatus }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-2xl ml-2", style: { fontFamily: "SourceHanCodeJP" }, children: "---" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-row ${status.weaponStatus === "CRITICAL ERROR" || status.weaponStatus === "JAMMED" ? "animate-pulse" : ""}`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ${status.weaponStatus === "CRITICAL ERROR" ? "text-red-500" : status.weaponStatus === "JAMMED" ? "text-purple-400" : "text-cyan-600"}`, style: { fontFamily: "SourceHanCodeJP" }, children: "> WEAPON: " }),
                  hudState.weapon ? /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ml-2 tracking-widest ${status.weaponStatus === "CRITICAL ERROR" ? "text-red-500" : status.weaponStatus === "JAMMED" ? "text-purple-400" : "text-white"} whitespace-nowrap`, style: { fontFamily: "SourceHanCodeJP" }, children: status.weaponStatus }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-2xl ml-2", style: { fontFamily: "SourceHanCodeJP" }, children: "---" })
                ] })
              ] }),
              status.systemMessage !== "" && /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { className: "text-yellow-400 text-2xl animate-pulse mt-4", style: { fontFamily: "SourceCodePro-Medium" }, children: [
                "> ",
  ...
  const ScorePopup = () => {
    ...
    const lastEventTimeRef = reactExports.useRef(0);
    ...
    reactExports.useEffect(() => {
      if (status.scoreEventTime > lastEventTimeRef.current && status.scoreEventAmount > 0) {
        ...
        requestAnimationFrame(() => {
          setPopups((prev) => prev.map((p) => p.id === id ? __spreadProps(__spreadValues({}, p), { opacity: 1, y: 0 }) : p));
        });
        setTimeout(() => {
          setPopups((prev) => prev.map((p) => p.id === id ? __spreadProps(__spreadValues({}, p), { opacity: 0, y: -20 }) : p));
          setTimeout(() => {
    ...
    return (
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "absolute top-40 right-8 flex-col items-end pointer-events-none", children: popups.map((popup) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "view",
        {
          ...
          children: [
            popup.label && /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-400 text-2xl font-mono mr-2", style: { textShadow: "0 0 5px cyan", fontFamily: "SourceHanCodeJP" }, children: popup.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { className: "text-yellow-400 text-4xl", style: { textShadow: "0 0 5px yellow", fontFamily: "SourceHanCodeJP" }, children: [
              "+",
              popup.amount
            ] })
          ]
  ...
  const Toaster = () => {
    ...
    const getSyncData = () => {
      ...
      if (status.toastMessage) {
        message = status.toastMessage;
        toastId = status.toastId;
      }
      return { message, toastId };
    };
    const [toastState, setToastState] = reactExports.useState(() => {
    ...
    reactExports.useEffect(() => {
      const msg = status.toastMessage;
      const id = status.toastId;
      if (msg) {
        setToastState({ message: msg, id, isVisible: true });
      } else {
        setToastState((prev) => __spreadProps(__spreadValues({}, prev), { isVisible: false }));
      }
    }, [status.toastId, status.toastMessage]);
      ...
      "view",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "view",
          {
            ...
            style: { minWidth: 300 },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: `mr-4 w-8 h-8 ${style.spin ? "custom-spin" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "image",
                {
                  source: style.icon,
                  style: {
  ...
  const OfflineIndicator = ({ className }) => {
    ...
    const [isVisible, setIsVisible] = reactExports.useState(!!isOffline);
    reactExports.useEffect(() => {
      setIsVisible(!!isOffline);
    }, [isOffline]);
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-row items-center bg-black bg-opacity-80 border border-red-500 px-3 py-1 rounded shadow-[0_0_10px_rgba(255,0,0,0.3)] transition-opacity duration-500 pointer-events-none ${isVisible ? "opacity-100" : "opacity-0"} ${className || ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "w-4 h-4 mr-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "image",
        {
  ...
  const SystemAlert = ({
    ...
    const globals = useGlobals();
    const interop = globals.GameInterop;
    const [selection, setSelection] = reactExports.useState(0);
    reactExports.useEffect(() => {
    ...
    reactExports.useEffect(() => {
      ...
      const originalInput = window.onMenuInput;
      window.onMenuInput = handleInput;
      return () => {
        window.onMenuInput = originalInput;
      };
    }, [onConfirm, onCancel, selection, interop, isOpen]);
    if (!isOpen) return null;
    return /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "absolute inset-0 flex items-center justify-center bg-black bg-opacity-95", style: { zIndex: 999 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "relative w-[1000px] bg-black p-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "absolute inset-0 border-2 border-red-500 shadow-[0_0_20px_rgba(255,0,0,0.5)] animate-pulse pointer-events-none" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "mb-6 items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        GlitchText,
        {
          text: title,
          isAlert: true,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "mb-8 text-center text-2xl text-white leading-relaxed whitespace-pre-wrap", style: { fontFamily: "SourceHanCodeJP" }, children: message }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row w-full mt-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: `flex-1 items-center justify-center py-4 mr-4 ${selection === 0 ? "bg-cyan-600" : "border border-gray-600"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "text",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: `flex-1 items-center justify-center py-4 ml-4 ${selection === 1 ? "bg-red-600" : "border border-gray-600"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "text",
          {
            className: "text-3xl text-center",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "absolute inset-0 pointer-events-none bg-black opacity-10" })
    ] }) });
  };
  const GameOverPanel = () => {
    const globals = useGlobals();
    ...
    reactExports.useEffect(() => {
      ...
      window.onMenuInput = (event) => {
        if (event === "left") {
          ...
          setTimeout(() => {
            if (selectedIndex === 0) {
              interop == null ? void 0 : interop.RestartGame();
            } else {
              interop == null ? void 0 : interop.ReturnToTitle();
            }
            setIsPressed(false);
          }, 200);
        }
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "view",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-col items-center p-12 border-4 border-red-600 bg-black w-[800px]", style: { fontFamily: "SourceHanCodeJP" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GlitchText, { text: "GAME OVER", isAlert: true, className: "text-8xl text-red-600 mb-4 tracking-widest whitespace-nowrap", style: { fontFamily: "SourceHanCodeJP" } }),
          status.isNewHighScore && /* @__PURE__ */ jsxRuntimeExports.jsx(GlitchText, { text: "NEW HIGH SCORE!", isAlert: false, className: "text-5xl text-yellow-400 mb-12 tracking-widest animate-pulse", style: { fontFamily: "SourceHanCodeJP" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row w-full justify-between px-12 mt-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "w-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              MenuButton,
              {
                label: "RETRY",
  ...
  const PausePanel = () => {
    ...
    reactExports.useEffect(() => {
      ...
      window.onMenuInput = (event) => {
        if (event === "left") {
          ...
          setTimeout(() => {
            if (selectedIndex === 0) {
              interop == null ? void 0 : interop.ResumeGame();
            } else {
              interop == null ? void 0 : interop.ReturnToTitle();
            }
            setIsPressed(false);
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      {
        className: "absolute inset-0 items-center justify-center bg-black bg-opacity-80 transition-opacity duration-500 pointer-events-auto",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-col items-center p-12 border-4 border-cyan-600 bg-black w-[800px]", style: { fontFamily: "SourceHanCodeJP" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(GlitchText, { text: "PAUSE", isAlert: false, className: "text-8xl text-cyan-600 mb-12 tracking-widest", style: { fontFamily: "SourceHanCodeJP" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row w-full justify-between px-12 mt-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "w-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              MenuButton,
              {
  ...
  const StageStartCutin = ({ stageName, onComplete, onProgress }) => {
    ...
    const globals = useGlobals();
    const interop = globals.GameInterop;
    const [appVersion, setAppVersion] = reactExports.useState("v0.3.0");
    reactExports.useEffect(() => {
    ...
    const onProgressRef = reactExports.useRef(onProgress);
    reactExports.useEffect(() => {
    ...
    const sequence = [
      ...
      { text: "INITIALIZING_INTERFACE...", delay: 500, action: "show_frame" },
      { text: "CONNECTING_ENGINE... OK", delay: 900, action: "show_engine" },
      { text: "LOADING_WEAPON_MODULES... OK", delay: 1200, action: "show_weapon" },
      { text: "CHECKING_VITAL_SIGNS... OK", delay: 1500, action: "show_vital" },
      { text: "STARTING_TELEMETRY... OK", delay: 1800, action: "show_telemetry" },
      { text: "SCANNING_ENVIRONMENT...", delay: 2100, action: "start_scan" },
      { text: `ENTRY_POINT_CONFIRMED: [ ${stageName} ]`, delay: 2600, action: "end_scan" },
      { text: "SYSTEM_ALL_GREEN", delay: 3e3, action: "show_system" },
      { text: "VISUAL_FEED_ONLINE", delay: 3400, action: "show_vision" },
      ...
      "view",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "view",
          {
            ...
            children: [
              isExiting && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "view",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row justify-between bg-cyan-900 px-2 py-1 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-100 text-xl font-mono", style: { fontFamily: "SourceHanCodeJP" }, children: "BOOT_SEQUENCE" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-col items-start p-4", children: [
                sequence.map((item, i) => {
  ...
  const GameApp = () => {
    ...
    const [isBlackout, setIsBlackout] = reactExports.useState(true);
    const [showOverlay, setShowOverlay] = reactExports.useState(true);
    const [isCutinPlaying, setIsCutinPlaying] = reactExports.useState(true);
    ...
    const [showConflictAlert, setShowConflictAlert] = reactExports.useState(false);
    const globals = useGlobals();
    const interop = globals.GameInterop;
    const status = useGameStatus();
    ...
    reactExports.useEffect(() => {
      window.onLoadingRequest = () => setIsLoading(true);
      window.onFadeOutRequest = () => setIsBlackout(true);
      window.onSaveConflict = () => setShowConflictAlert(true);
      return () => {
        window.onLoadingRequest = () => {
        };
        window.onFadeOutRequest = () => {
        };
        window.onSaveConflict = () => {
        };
      };
    }, []);
    reactExports.useEffect(() => {
    ...
    const handleCutinComplete = reactExports.useCallback(() => {
      console.log("[GameApp] Cutin Complete -> Force clearing blackout");
      setIsCutinPlaying(false);
      setIsBlackout(false);
      interop == null ? void 0 : interop.StartGameLoop();
    }, [interop]);
    const handleCutinProgress = reactExports.useCallback((action) => {
      console.log(`[GameApp] handleCutinProgress received: ${action}`);
      if (action === "show_frame") {
        setHudState((prev) => __spreadProps(__spreadValues({}, prev), { frame: true, labels: true }));
      } else if (action === "show_engine") {
        setHudState((prev) => __spreadProps(__spreadValues({}, prev), { engine: true }));
      } else if (action === "show_weapon") {
        setHudState((prev) => __spreadProps(__spreadValues({}, prev), { weapon: true }));
      } else if (action === "show_vital") {
        setHudState((prev) => __spreadProps(__spreadValues({}, prev), { vital: true }));
      } else if (action === "show_telemetry") {
        setHudState((prev) => __spreadProps(__spreadValues({}, prev), { telemetry: true }));
      } else if (action === "start_scan") {
        setHudState((prev) => __spreadProps(__spreadValues({}, prev), { env: true, isScanning: true }));
      } else if (action === "end_scan") {
        setHudState((prev) => __spreadProps(__spreadValues({}, prev), { isScanning: false }));
      } else if (action === "show_system") {
        setHudState((prev) => __spreadProps(__spreadValues({}, prev), { system: true }));
      } else if (action === "show_vision") {
        console.log("[GameApp] show_vision -> Setting isBlackout to false");
        setIsBlackout(false);
      }
    }, []);
    const handleResolveConflict = reactExports.useCallback((overwriteLocal) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "absolute top-0 left-0 w-full h-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AspectRatioWrapper, { onReady: handleUIReady, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "absolute inset-0", style: { width: "100%", height: "100%" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(PausePanel, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(GameOverPanel, {}),
        isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "absolute inset-0 items-center justify-center bg-black bg-opacity-80 pointer-events-none", style: { zIndex: 9998 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row items-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "absolute inset-0 pointer-events-none", style: { zIndex: 1e4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(HUD, { hudState }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "absolute inset-0 pointer-events-none", style: { zIndex: 1e4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScorePopup, {}) }),
        isCutinPlaying && /* @__PURE__ */ jsxRuntimeExports.jsx(
          StageStartCutin,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(OfflineIndicator, { className: "absolute top-4 left-4" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          SystemAlert,
          {
  ...
  render(/* @__PURE__ */ jsxRuntimeExports.jsx(GameApp, {}));
})();
