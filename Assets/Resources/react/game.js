...
(function() {
  ...
  const ScorePopup = () => {
    ...
    return (
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("view", { className: "absolute top-44 right-8 flex-col items-end pointer-events-none", children: popups.map((popup) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "view",
        {
