            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-1 border-t-2 border-cyan-900 pt-4 mt-auto transition-opacity duration-500 ${hudState.labels ? "opacity-100" : "opacity-0"}`, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-col gap-1 opacity-70", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ${status.engineStatus === "OFFLINE" ? "text-red-500" : "text-cyan-600"}`, children: "> ENGINE: " }),
                  hudState.engine ? /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ml-2 ${status.engineStatus === "OFFLINE" ? "text-red-500" : "text-white"}`, children: status.engineStatus }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-2xl ml-2", children: "---" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-600 text-2xl", children: "> WEAPON: " }),
                  hudState.weapon ? /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-white text-2xl ml-2", children: status.weaponStatus }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-2xl ml-2", children: "---" })
                ] })
              ] }),
          ...
          "view",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row justify-between bg-cyan-900 px-2 py-1 mb-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-100 text-xl font-mono", style: { fontFamily: "SourceHanCodeJP" }, children: "v3.0.1" })
              ] }),
