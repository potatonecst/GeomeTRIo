          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-col transition-opacity duration-500 ${hudState.labels ? "opacity-100" : "opacity-0"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "mb-8", children: [
                ...
                hudState.telemetry ? /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-white text-7xl tracking-widest whitespace-nowrap", style: { fontFamily: "SourceHanCodeJP" }, children: status.score.toString().padStart(8, "0") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-7xl tracking-widest whitespace-nowrap", style: { fontFamily: "SourceHanCodeJP" }, children: "00000000" })
              ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-1 border-t-2 border-cyan-900 pt-4 mt-auto transition-opacity duration-500 ${hudState.labels ? "opacity-100" : "opacity-0"}`, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-col gap-1 opacity-70", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-row ${status.hp <= 1 ? "animate-pulse" : ""}`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ${status.hp <= 1 ? "text-red-500" : "text-cyan-600"}`, children: "> SYSTEM: " }),
                  hudState.system ? /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ml-2 ${status.hp <= 1 ? "text-red-500" : "text-green-500"}`, children: status.systemStatus }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-2xl ml-2", children: "---" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-row ${status.engineStatus === "DESTROYED" ? "animate-pulse" : ""}`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ${status.engineStatus === "DESTROYED" ? "text-red-500" : "text-cyan-600"}`, children: "> ENGINE: " }),
                  hudState.engine ? /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ml-2 ${status.engineStatus === "DESTROYED" ? "text-red-500" : "text-white"}`, children: status.engineStatus }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-2xl ml-2", children: "---" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-row ${status.weaponStatus === "CRITICAL ERROR" ? "animate-pulse" : ""}`, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ${status.weaponStatus === "CRITICAL ERROR" ? "text-red-500" : "text-cyan-600"}`, children: "> WEAPON: " }),
                  hudState.weapon ? /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ml-2 ${status.weaponStatus === "CRITICAL ERROR" ? "text-red-500" : "text-white"}`, children: status.weaponStatus }) : /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-gray-700 text-2xl ml-2", children: "---" })
                ] })
              ] }),
              status.systemMessage !== "" && /* @__PURE__ */ jsxRuntimeExports.jsxs("text", { className: "text-yellow-400 text-2xl animate-pulse mt-4 font-bold", children: [
                "> ",
          ...
          "view",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row justify-between bg-cyan-900 px-2 py-1 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-100 text-xl font-mono", style: { fontFamily: "SourceHanCodeJP" }, children: "TERMINAL_OUTPUT" }),
