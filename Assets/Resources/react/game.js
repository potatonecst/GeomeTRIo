...
(function() {
  ...
  const HUD = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "w-full h-full pointer-events-none relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `${sidebarStyle} border-r-2 items-end left-0`, style: { width: 550 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-600 text-3xl tracking-widest mb-1", children: "OPERATION" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-white text-4xl tracking-widest mb-8", style: { fontFamily: "SourceHanCodeJP" }, children: status.stageName }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-600 text-3xl tracking-widest mb-1", children: "TIME" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-white text-4xl tracking-widest mb-auto", style: { fontFamily: "SourceHanCodeJP" }, children: formatTime(status.timeElapsed) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `${sidebarStyle} border-l-2 right-0`, style: { width: 550 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "mb-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressBar, { value: status.currentExp, max: status.nextExp, color: "#facc15" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-1 border-t-2 border-cyan-900 pt-4 mt-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-col gap-1 opacity-70", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: `flex-row ${status.hp <= 1 ? "animate-pulse" : ""}`, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ml-2 ${status.hp <= 1 ? "text-red-500" : "text-white"}`, children: status.systemStatus })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ${status.combatStatus === "OFFLINE" ? "text-red-500" : "text-cyan-600"}`, children: "> COMBAT: " }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: `text-2xl ml-2 ${status.combatStatus === "OFFLINE" ? "text-red-500" : "text-white"}`, children: status.combatStatus })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "flex-row", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-cyan-600 text-2xl", children: "> WEAPON: " }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("text", { className: "text-white text-2xl ml-2", children: status.weaponStatus })
            ] })
          ] }),
