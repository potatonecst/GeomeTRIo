...
(function() {
  ...
  const GameApp = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(AspectRatioWrapper, { onReady: handleUIReady, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("view", { className: "absolute inset-0", style: { width: "100%", height: "100%" }, children: [
